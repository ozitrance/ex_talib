...
df
 ...
 df
  ...
  rsi: ExTalib.rsi!(&1[:close], &1[:open], &[:whatever])
  ema: ExTalib.ema!(&1[:close], &1[:open], &[:whatever])
  cci: ExTalib.cci!(&1[:close], &1[:open], &[:whatever])
  bbands: ExTalib.bbands!(&1[:close], &1[:open], &[:whatever])
  ])
